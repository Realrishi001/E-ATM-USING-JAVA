...
public class PinChange extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == back) {
            ...
            String query3 = "update signup3 set pinnumber='"+newPin+"' where pin='"+pinnumber+"' ";
            ...
            setVisible(false);
            new Transactions(pinnumber).setVisible(true);  // Assuming you have a Transactions screen
